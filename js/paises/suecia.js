window.SWEDEN_CONTENT={
  ...
  itineraries:[
    {title:'Estocolmo en 3 días',tag:'3 DÍAS · CIUDAD',text:'Nuestro recorrido de 3 días por Estocolmo, organizado día a día.',image:'https://images.unsplash.com/photo-1509356843151-3e7d96241e11?auto=format&fit=crop&w=1000&q=88',available:true,href:'estocolmo/itinerario.html'},
  ...
  preparation:[
    {icon:'◷',title:'Cuándo ir',text:'Nosotros priorizaríamos finales de primavera y verano si quieres carretera, naturaleza y días muy largos. Invierno sólo si buscas nieve y otro tipo de viaje.',image:'https://images.unsplash.com/photo-1483347756197-71ef80e95f73?auto=format&fit=crop&w=900&q=85',available:true,href:'../../planifica/index.html',ctaLabel:'VER DETALLE'},
  ...
  faq:[
    ...
    {question:'¿Cuál es la mejor época para viajar?',answer:'Depende del viaje. El verano ofrece días muy largos; el invierno cambia por completo la experiencia.'},
    {question:'¿Necesito visado para entrar?',answer:'Los requisitos dependen de tu nacionalidad. Conviene consultar siempre la información oficial actualizada.'},
    {question:'¿Cómo es el clima?',answer:'Es muy variable según la zona y la estación. El norte es bastante más frío.'},
    {question:'¿Cuál es la moneda y se puede pagar con tarjeta?',answer:'La moneda es la corona sueca (SEK). El pago con tarjeta está muy extendido.'},
    {question:'¿Es necesario un coche para recorrer el país?',answer:'No para Estocolmo y otras ciudades, pero sí es muy recomendable para road trips por zonas rurales.'},
    {question:'¿Qué enchufes se utilizan?',answer:'Suecia utiliza enchufes tipo C y F, con 230 V.'},
    {question:'¿Qué ropa llevar?',answer:'Lleva capas y una prenda impermeable incluso en verano. En invierno necesitarás ropa térmica.'},
    {question:'¿Es caro viajar a Suecia?',answer:'No es un destino barato, pero se puede controlar bastante el presupuesto reservando con tiempo.'},
    {question:'¿Hay cobertura móvil e internet?',answer:'La cobertura es buena en ciudades y carreteras principales, aunque baja en algunas zonas remotas.'}
  ]
};